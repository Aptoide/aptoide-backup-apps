...
public class Schema extends SQLiteOpenHelper {
    ...
    private static final String createTable_RepoApk = "CREATE TABLE " + TABLE_REPO_APK + " ( " +
            "    " + _ID + "          INTEGER PRIMARY KEY ON CONFLICT IGNORE AUTOINCREMENT," +
            "    " + PACKAGE_NAME + " VARCHAR DEFAULT ( '' ) " +
            "                         COLLATE 'NOCASE'," +
            "    " + NAME + "         VARCHAR DEFAULT ( '' ) " +
            "                         COLLATE 'NOCASE'," +
            "    " + VERSION_NAME + " VARCHAR DEFAULT ( '' )," +
            "    " + VERSION_CODE + " INTEGER," +
            "    " + ICON_PATH + "    VARCHAR DEFAULT ( '' )," +
            "    " + PATH + "    VARCHAR DEFAULT ( '' )," +
            "    " + MD5 + "    VARCHAR DEFAULT ( '' )," +
            "    " + SIZE + "         REAL    DEFAULT ( 0 ), " +
            "    " + DATE + "         DATE    " +
            ");";
    private static final String createTable_Repo = "CREATE TABLE " + TABLE_REPO + " ( " +
            "    " + _ID + "       INTEGER PRIMARY KEY," +
            "    " + URL +"       VARCHAR NOT NULL," +
            "    " + HASH +"      VARCHAR DEFAULT ( '' )," +
            "    " + APK_PATH + "  VARCHAR DEFAULT ( '' )," +
            "    " + ICON_PATH + " VARCHAR DEFAULT ( '' )," +
            "    " + USERNAME + " VARCHAR DEFAULT ( '' )," +
            "    " + PASSWORD + " VARCHAR DEFAULT ( '' )," +
            "    " + APPSCOUNT + " INTEGER DEFAULT ( 0 ) " +
            ");";
    private static final String createTable_InstalledApk = "CREATE TABLE " + TABLE_INSTALLED_APK + " ( " +
            "    " + _ID + "          INTEGER PRIMARY KEY," +
            "    " + PACKAGE_NAME + " VARCHAR UNIQUE ON CONFLICT REPLACE," +
            "    " + NAME + "         VARCHAR DEFAULT ( '' )," +
            "    " + VERSION_NAME + " VARCHAR DEFAULT ( '' )," +
            "    " + VERSION_CODE + " INTEGER " +
            ");";

    private static final String createIndex_Installed = "CREATE INDEX idx_installed_apk ON " + TABLE_INSTALLED_APK + " ( " +
            "    " + _ID + "," +
            "    " + PACKAGE_NAME + "," +
            "    " + VERSION_CODE + " " +
            ");";

    private static final String createIndex_RepoApk = "CREATE INDEX idx_repo_apk ON " + TABLE_REPO_APK + " ( " +
            "    " + _ID + "," +
            "    " + PACKAGE_NAME + "," +
            "    " + VERSION_CODE + " " +
            ");";
