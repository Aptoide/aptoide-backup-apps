...
public class NetworkUtils {
  ...
  public static BufferedInputStream getInputStream(String url, String username, String password,
      Context mctx) throws IOException {
  ...
  public static int checkServerConnection(String string, String username, String password)
      throws IOException {
  ...
  public static JSONObject getJsonObject(String url, Context mctx)
  ...
  public static String getUserAgentString(Context mctx) {
    ...
    try {
      verString = mctx.getPackageManager()
    ...
    return "aptoideAppsBackup-"
        + verString
        + ";"
        + Constants.TERMINAL_INFO
        + ";"
        + myscr
        + ";id:"
        + myid
        + ";"
        + sPref.getString(Constants.LOGIN_USER_LOGIN, "")
        + ";"
        + partnerid;
  }
  ...
  public static boolean isConnectionAvailable(Context context) {
    ...
    try {
      connectionAvailable = connectivityState.getNetworkInfo(0)
    ...
    try {
      connectionAvailable = connectionAvailable
          || connectivityState.getNetworkInfo(1)
          .getState() == NetworkInfo.State.CONNECTED;
    ...
    try {
      connectionAvailable = connectionAvailable
          || connectivityState.getNetworkInfo(9)
          .getState() == NetworkInfo.State.CONNECTED;
  ...
  public static InputStream getInputStream(String urlString, Context applicationContext)
      throws IOException {
