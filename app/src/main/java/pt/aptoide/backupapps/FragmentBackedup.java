...
public class FragmentBackedup extends SherlockListFragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        backedUpAdapter = new BackedUpCursorAdapter(context, null, CursorAdapter.FLAG_REGISTER_CONTENT_OBSERVER, backedUpApps);//To change body of overridden methods use File | Settings | File Templates.
    ...
    @Subscribe
    public void onRefresh(BackedUpRefreshEvent event){

        Bundle bundle = new Bundle();
        bundle.putInt("order", event.getSort().ordinal());
        getLoaderManager().restartLoader(0, bundle, this);
    }

    @Subscribe
    public void onRefreshBackedUpApps(final RefreshInstalledAppsEvent event){
    ...
    @Subscribe
    public void onActionModeFinish(ActionModeFinishEvent event ){
    ...
    public android.support.v4.content.Loader<Cursor> onCreateLoader(int i, final Bundle bundle) {
        return new SimpleCursorLoader(getSherlockActivity()) {
            ...
            public Cursor loadInBackground() {
                return Database.getInstance().getAvailable(bundle.getInt("order"));  //To change body of implemented methods use File | Settings | File Templates.
            }
        };
    }
    ...
    @Subscribe
    public void onStartParse(StartParseEvent event){
    ...
    @Subscribe
    public void onStopParse(StopParseEvent event){
