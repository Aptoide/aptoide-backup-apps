...
public class CheckUserCredentials extends AsyncTask<Login, Void, LoginResponse> {
    ...
    @Override
    protected LoginResponse doInBackground(Login... params) {
        ...
        try {
            ...
            if(loginMode == Login.LoginMode.REGULAR) {
                ...
                if(login.getRepo() == null) {
                    ...
                    requestData += "&" + URLEncoder.encode("privacy", "UTF-8") + "=" + URLEncoder.encode(((login.isRepoPrivate()) ? "true" : "false"), "UTF-8");
                }
            }
            requestData += "&" + URLEncoder.encode("mode", "UTF-8") + "=" + URLEncoder.encode("json", "UTF-8");
    ...
    protected void onPostExecute(LoginResponse response) {
        ...
        switch (response.getError()){
            ...
            case SUCCESS:
                ...
                sPref.edit().putString(Constants.LOGIN_USER_LOGIN, login.getUsername())
                        .putString(Constants.LOGIN_USER_PASSWORD, ((login.getPassword() != null) ? login.getPasswordSha1() : ""))
            ...
            case REPO_NAME_ALREADY_EXISTS:
                Toast.makeText(activity, response.getError().toString(activity), Toast.LENGTH_SHORT).show();
                showRepoCreatorDialog();
                break;
    ...
    public class RepoCreatorDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            ContextThemeWrapper contextThemeWrapper = new ContextThemeWrapper(activity, R.style.RepoDialog);
