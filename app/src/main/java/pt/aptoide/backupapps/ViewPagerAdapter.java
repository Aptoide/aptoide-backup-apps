...
public class ViewPagerAdapter extends PagerAdapter {
  ...
  @Override public Object instantiateItem(ViewGroup container, int position) {
    ...
    return views.get(
        position);    //To change body of overridden methods use File | Settings | File Templates.
  }
  ...
  @Override public boolean isViewFromObject(View view, Object o) {
    return view.equals(
        o);  //To change body of implemented methods use File | Settings | File Templates.
  }
