...
public class WebserviceGetApkInfo {
    ...
    public WebserviceGetApkInfo(String webservice, RepoApk apk) throws IOException, JSONException {
        ...
        url.append("webservices/getApkInfo/").append(apk.getRepoName()).append("/")
                ...
                .append(URLEncoder.encode(apk.getVersionName(),"UTF-8")).append("/")
                .append("options=")
        ...
        BufferedReader br = new BufferedReader(new InputStreamReader(NetworkUtils.getInputStream(url.toString(), null, null, BackupAppsApplication.getContext())));
