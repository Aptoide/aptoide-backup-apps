...
public enum EnumUploadFailReason {
    ...
    APK_BLACKLISTED, OBB_PATCH_APK_NO_MD5, OBB_PATCH_MAIN_APK_NO_MD5, OBB_MAIN_APK_NO_MD5, OBB_PATCH_NO_MD5, OBB_PATCH_MAIN_NO_MD5, OBB_MAIN_NO_MD5,

    APK_EMPTY,
    HMAC_AUTHENTICATION_FAILURE,

    INVALID_UPLOAD_TYPE,
    UPLOAD_FROM_INVALID,

    EMPTY_OBB_MAIN_FILE,
    EMPTY_OBB_PATCH_FILE,
    INVALID_OBB_MAIN_FILE,
    INVALID_OBB_PATCH_FILE,
    OBB_MAIN_FILE_EXCEEDS_MAXIMUM_SIZE,
    OBB_PATCH_FILE_EXCEEDS_MAXIMUM_SIZE,
    OBB_MAIN_FILE_TRANSFER_STOPPED,
    OBB_PATCH_FILE_TRANSFER_STOPPED,
    OBB_MAIN_FILE_TRANSFER_FAILED,
    OBB_PATCH_FILE_TRANSFER_FAILED,
    OBB_MAIN_FILE_PROCESSING_PROBLEM,
    OBB_PATCH_FILE_PROCESSING_PROBLEM,

    INVALID_OBB_MAIN_NAME,
    INVALID_OBB_PATCH_NAME,
    OBB_MAIN_FILE_MD5_MISMATCH,
    OBB_PATCH_FILE_MD5_MISMATCH,
    OBB_MAIN_FILE_TYPE_MISMATCH,
    OBB_PATCH_FILE_TYPE_MISMATCH,
    OBB_MAIN_FILE_VERSION_MISMATCH,
    OBB_PATCH_FILE_VERSION_MISMATCH,
    OBB_MAIN_FILE_PACKAGE_MISMATCH,
    OBB_PATCH_FILE_PACKAGE_MISMATCH,
    PATCH_OBB_FILE_WITHOUT_MAIN_OBB,
    BAD_USER_CATEGORY,
    APK_MAXIMUM_SIZE, UNKONWN, APK_NOT_FOUND,
    ANTI_SPAM_RULE, INVALID_APK_ORIGIN, INVALID_APK_DATA, INVALID_ORIGIN_FOR_SIGNUP
    ;
